...
\newtheorem{theoremENG}[subsubsection]{\begin{english}Theorem\end{english}}
...
\theoremstyle{factENG}
\newtheorem{factENG}[subsubsection]{\begin{english}Fact\end{english}}
...
\newtheorem{questionENG}[subsubsection]{\begin{english}Question\end{english}}
\theoremstyle{guessENG}
\newtheorem{guessENG}[subsubsection]{\begin{english}Guess\end{english}}
\theoremstyle{answerENG}
\newtheorem{answerENG}[subsubsection]{\begin{english}Answer\end{english}}
...
\newtheorem{conjectureENG}[subsubsection]{\begin{english}Conjecture\end{english}}
\theoremstyle{postulateENG}
\newtheorem{postulateENG}[subsubsection]{\begin{english}Postulate\end{english}}
...
\newtheorem{theoremRUS}[subsubsection]{\begin{russian}Теорема\end{russian}}
\theoremstyle{lemmaRUS}
\newtheorem{lemmaRUS}[subsubsection]{\begin{russian}Лемма\end{russian}}
\theoremstyle{propositionRUS}
\newtheorem{propositionRUS}[subsubsection]{\begin{russian}Утверждение\end{russian}}
\theoremstyle{corollaryRUS}
\newtheorem{corollaryRUS}[subsubsection]{\begin{russian}Следствие\end{russian}}
\theoremstyle{factRUS}
\newtheorem{factRUS}[subsubsection]{\begin{russian}Факт\end{russian}}
...
\newtheorem{questionRUS}[subsubsection]{\begin{russian}Вопрос\end{russian}}
\theoremstyle{guessRUS}
\newtheorem{guessRUS}[subsubsection]{\begin{russian}Догадка\end{russian}}
\theoremstyle{answerRUS}
\newtheorem{answerRUS}[subsubsection]{\begin{russian}Ответ\end{russian}}
\theoremstyle{constructionRUS}
\newtheorem{constructionRUS}[subsubsection]{\begin{russian}Конструкция\end{russian}}
...
\newtheorem{conjectureRUS}[subsubsection]{\begin{russian}Гипотеза\end{russian}}
\theoremstyle{postulateRUS}
\newtheorem{postulateRUS}[subsubsection]{\begin{russian}Постулат\end{russian}}
...
\footnote{Мы определили композицию функций на странице \ref{function composition}, но здесь мы используем другое обозначение.\index{a warning!notation for composition} Там мы бы сказали, что $g\circ f = i\circ h$, следуя {\em классическому порядку}, который выглядит задом-наперед.\index{composition!classical order} Категорные теоретики и другие часто предпочитают {\em диаграммный порядок}\index{composition!diagrammatic order} для записи композиции, а именно $f;g = h;i$. В случае ологов мы используем последний вариант, потому что он лучше соответствует порядку слов естественного языка, и по тем же причинам мы добавили объект-начало в уравнение $A f g \simeq A h i$.}
