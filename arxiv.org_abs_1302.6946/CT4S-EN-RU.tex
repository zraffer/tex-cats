...
Утверждение \ref{prop:pasting} может оказаться полезным при создании ологов. Например, тип \fakebox{мобильный телефон с плохим аккумулятором} определен неточно, но мы можем точно сформулировать, что оно означет, используя пулбеки:
\small
\begin{align}\label{dia:bad battery}
