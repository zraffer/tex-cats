...
\usepackage{savesym}
\setmainfont{Ubuntu}%{XITS}
\setmathfont{XITS Math}
\setmainlanguage{russian}
\setotherlanguage{english}
\newfontfamily\russianfont{Ubuntu}%{XITS}
