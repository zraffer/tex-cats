...
\endnote{
В англоязычной литературе слово science обозначает как науки вообще, так и только естественные науки, в этом случае науки гуманитарные называют humanities [см. The Two Cultures]. Выражая робкую надежду, что эта книга пригодится также и представителям последних, мы переводим science/scientist как наука/ученый вообще, не ограничивая их естественнонаучной направленностью.
...
\endnote{
Данная книга не является единственной работой автора в области категорных оснований баз данных и представления знаний в информатике. Желающие увидеть полный список могут обратиться к сайту Категорные Данные \cite{CDSite}, а также к персональной странице Д. И. Спивака \cite{SpHome}.
}
...
...(дать понятие об аксиоматическом методе, как реальном основании математики, а также о различии логической парадигмы и алгебраической; теория - метатеория - модели)...
}
...
\endnote{
(дать краткий обзор областей теории категорий в исторической перспективе по темам: функторы, сопряжения, монады, алгебраические теории с категорной точки зрения, топосы как пример последних, теория высших категорий (гомотопии, кобордизмы, категория категорий), HoTT Воеводского)
}
...
\endnote{
(и сюда дизайн-паттерны пробрались... или имеются в виду не они? уточнить!)
...
\endnote{
  (возможно, пара слов о логической парадигме более конкретно: нужны ли нам понятия о предикатах и кванторах?)
}
...
\endnote{
Попробовать поменять подобные [в качестве] на [с помощью].
}
...
\endnote{
(дать наброски решений некоторых упражнений)
}
\end{exerciseRUS}
...
\begin{definitionRUS}[Притягивающий квадрат]\label{def:pullback}\index{выталкивающий квадрат!множеств}
Предположим, дана такая диаграмма множеств и функций:
\begin{align}\label{dia:fp sets}
\xymatrix{&Y\ar[d]^g\\
X\ar[r]_f&Z}
\end{align}
...
\next Универсальное свойство произведений обеспечивает нам функцию $X\times_CY\to X\times Y$, которая, можете мне поверить, будет инъекцией. Это означает, что рисунок расслоенного произведения, который вы сделали, может быть вставлен в сетку $5\times 3$; сделайте, пожалуйста, такую сетку и отметьте на ней подмножество.
\endsexc
\end{exerciseRUS}
...
\begin{remarkRUS}
Некоторые предпочитают обозначать расслоенное произведение $f\times_Zg$, а не $X\times_ZY$. Первое обозначение математически лучше, но читабельность для человека часто лучше у второго, которое, кроме того, чаще встречается в литературе. Мы будем использовать такое обозначение, которое окажется более удобным.
\end{remarkRUS}
