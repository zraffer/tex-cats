...
Пусть $n\in\NN$ — некоторое натуральное число. {\em Граф-цепь длины $n$},\index{граф!цепь} обозначаемый $[n],$ — это граф, изображенный ниже:
$$\xymatrix{
    \LMO{0}\ar[r]  &  \LMO{1}\ar[r]  &  \cdots\ar[r]  &  \LMO{n}
}$$
