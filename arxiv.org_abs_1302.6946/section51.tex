...
\subsubsection{\caseENGRUS{Pullback}{ / }{Пулбек}: \texorpdfstring{$\Delta$}{Δ}}
...
\subsubsection{\caseENGRUS{Left pushforward}{ / }{Левое расширение Кана}: \texorpdfstring{$\Sigma$}{Σ}}\label{sec:left push}
...
\subsubsection{\caseENGRUS{Right pushforward}{ / }{Правое расширение Кана}: \texorpdfstring{$\Pi$}{Π}}
