...
\subsubsection{\caseENGRUS{Monoids as categories}{ / }{Моноиды как категории}}\label{sec:monoids as cats}\index{monoid!as category}
...
\subsubsection{\caseENGRUS{Groups as categories}{ / }{Группы как категории}}\index{group!as category}
...
\subsubsection{\caseENGRUS{Preorders as categories}{ / }{Предпорядки как категории}}\label{sec:preorder as cat}\index{preorder!as category}
...
\subsubsection{\caseENGRUS{Graphs as functors}{ / }{Графы как функторы}}\label{sec:graphs as functors}\index{graph!as functor}
...
\subsection{\caseENGRUS{Database schemas present categories}{ / }{Схемы баз данных представляют собой категории}}\label{sec:schemas and cats intro}\index{schema!as category presentation}
...
\subsubsection{\caseENGRUS{Instances on a schema $\mcC$}{ / }{Экземпляры схемы $\mcC$}}\label{sec:instances}\index{database!instance}\index{instance}
...
\subsection{\caseENGRUS{Spaces}{ / }{Пространства}}\index{space}
...
\begin{exampleENG}\label{ex:topological space}\index{space!topological}\index{topology}
...
\subsubsection{\caseENGRUS{Groupoids}{ / }{Группоиды}}\label{sec:groupoid}\index{groupoid}
...
\subsubsection{\caseENGRUS{The category of propositions}{ / }{Категория утверждений}}\label{sec:propositions}\index{a category!$\Prop$}
...
\subsubsection{\caseENGRUS{A categorical characterization of $\Set$}{ / }{Категорная характеризация $\Set$}}\index{set!Lawvere's description of}
...
\subsubsection{\caseENGRUS{Categories in computer science}{ / }{Категории в теоретической информатике}}\index{CCCs}\index{category!cartesian closed}
