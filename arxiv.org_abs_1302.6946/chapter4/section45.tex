...
\subsubsection{\caseENGRUS{Products}{ / }{Произведения}}
...
Here is the most important thing to notice. Look at the {\tt Arrow} table for $I\times J,$ and for each ordered pair, look only at the second entry in all three columns; you will see something that matches with the {\tt Arrow} table for $J.$ Do the same for $I,$ and again you'll see a perfect match. These “matchings” are readily-visible graph homomorphisms $I\times J{→} I$ and $I\times J{→} J$ in $\Grph.$ 
\end{exampleENG}
...
$$\Loop{\coloneqq}\LoopSchema$$\index{a schema!$\Loop$}
...
\begin{definitionENG}\label{def:products in a cat}\index{products}
...
\begin{definitionRUS}\label{def:products in a cat}\index{products}
\end{definitionRUS}

\begin{remarkENG}\label{rem:gateway}\index{gateway}\index{universal property}
...
\begin{exampleRUS}\label{ex:products dont exist}\index{products!as not always existing}
\end{exampleRUS}
...
\subsubsection{\caseENGRUS{Coproducts}{ / }{Копроизведения}}
...
\begin{definitionENG}\label{def:coproducts in a cat}\index{coproducts}
Let ${𝓒}$ be a category and let $X,Y\in\Ob({𝓒})$ be objects. A {\em cospan on $X$ and $Y$}\index{cospan} consists of three constituents $(Z,i,j),$ where $Z\in\Ob({𝓒})$ is an object, and where $i\colon X{→} Z$ and $j\colon Y{→} Z$ are morphisms in ${𝓒}.$ 
...
\subsection{\caseENGRUS{Diagrams in a category}{ / }{Диаграммы в категории}}\label{sec:diagrams in a category}
...
\begin{definitionENG}\index{diagram}\index{indexing category}
...
\begin{definitionRUS}\index{diagram}\index{indexing category}
\end{definitionRUS}
...
\begin{definitionENG}\label{def:lcone}\index{cone!left}
Let $I\in\Ob(\Cat)$ be a category. The {\em left cone on $I$}, denoted $I{^{⊲}}$\index{a symbol!${^{⊲}}$}, is the category defined as follows. On objects we put $\Ob(I{^{⊲}})=\{-\infty\}\sqcup\Ob(I),$ and we call the new object $-\infty$ the {\em cone point of $I{^{⊲}}$}. On morphisms we add a single new morphism $s_b\colon-\infty{→} b$ for every object $b\in\Ob(I)$; more precisely,
$$\Hom_{I{^{⊲}}}(a,b)=
\begin{cases}
...
\begin{definitionRUS}\label{def:lcone}\index{cone!left}
\end{definitionRUS}
...
\begin{exampleENG}\label{ex:stars}\index{a category!$\Star_n$}
...
\begin{exampleRUS}\label{ex:stars}\index{a category!$\Star_n$}
\end{exampleRUS}
...
\begin{definitionENG}\label{def:rcone}\index{cone!right}
Let $I\in\Ob(\Cat)$ be a category. The {\em right cone on $I$}, denoted $I{^{⊳}},$\index{a symbol!${^{⊳}}$} is the category defined as follows. On objects we put $\Ob(I{^{⊳}})=\Ob(I)\sqcup\{\infty\},$ and we call the new object $\infty$ the {\em cone point of $I{^{⊳}}$}. On morphisms we add a single new morphism $t_b\colon b{→}\infty$ for every object $b\in \Ob(I)$; more precisely,
$$\Hom_{I{^{⊳}}}(a,b)=
\begin{cases}
\Hom_I(a,b)&\tn{ if }a,b\in\Ob(I)\\
...
\begin{definitionRUS}\label{def:rcone}\index{cone!right}
\end{definitionRUS}
...
\begin{definitionENG}\index{initial object}\index{terminal object}
...
\begin{definitionRUS}\index{initial object}\index{terminal object}
\end{definitionRUS}
...
\begin{warningENG}\index{a warning!misuse of {\em the}}
...
\begin{warningRUS}\index{a warning!misuse of {\em the}}
\end{warningRUS}
...
\begin{exampleENG}\label{ex:initial monoid terminal monoid}\index{monoid!initial}\index{monoid!terminal}
...
\begin{exampleRUS}\label{ex:initial monoid terminal monoid}\index{monoid!initial}\index{monoid!terminal}
\end{exampleRUS}
...
\begin{constructionENG}[Products]\index{products}
...
\begin{constructionRUS}[Products]\index{products}
\end{constructionRUS}
...
\begin{definitionENG}\label{def:slice and limit}\index{category!slice}\index{slice}\index{limit}
Let ${𝓒}$ be a category, let $I$ be a category; let $I{^{⊲}}$ be the left cone on $I,$ and let $i\colon I{→} I{^{⊲}}$ be the inclusion. Suppose that $X\colon I{→}{𝓒}$ is an $I$-shaped diagram in ${𝓒}.$ The {\em slice category of ${𝓒}$ over $X$} denoted ${𝓒}_{/X}$\index{a symbol!${𝓒}_{/X}$} is the category whose objects and morphisms are as follows:
\begin{align*}
\Ob({𝓒}_{/X})&=\{S\colon I{^{⊲}}{→}{𝓒}{\;|\;}S\circ i=X\}\\
\Hom_{{𝓒}_{/X}}(S,S')&=\{\alpha\colon S{→} S'{\;|\;}\alpha\circ i=\id_X\}.
\end{align*}

A {\em limit of $X$}, denoted $\lim_IX$ or $\lim X,$\index{a symbol!$\lim$} is a terminal object in ${𝓒}_{/X}.$
\end{definitionENG}

\begin{definitionRUS}\label{def:slice and limit}\index{category!slice}\index{slice}\index{limit}
\end{definitionRUS}

\paragraph{\caseENGRUS{Pullbacks}{ / }{Пулбеки}}\index{pullback}\index{universal property!pullback} ~\\
...
\begin{exerciseENG}\index{equalizer}
...
\begin{exerciseRUS}\index{equalizer}
\end{exerciseRUS}
...
\begin{exampleENG}\label{ex:product version of nat trans}\index{natural transformation!as functor}
...
\begin{exampleRUS}\label{ex:product version of nat trans}\index{natural transformation!as functor}
\end{exampleRUS}

\begin{remarkENG}\index{relative set!as slice category}
...
\begin{remarkRUS}\index{relative set!as slice category}
\end{remarkRUS}
...
\begin{definitionENG}\label{def:coslice and colimit}\index{coslice}\index{category!coslice}\index{colimit}
Let ${𝓒}$ be a category, let $I$ be a category; let $I{^{⊳}}$ be the right cone on $I,$ and let $i\colon I{→} I{^{⊳}}$ be the inclusion. Suppose that $X\colon I{→}{𝓒}$ is an $I$-shaped diagram in ${𝓒}.$ The {\em coslice category of ${𝓒}$ over $X$} denoted ${𝓒}_{X/}$\index{a symbol!${𝓒}_{X/}$} is the category whose objects and morphisms are as follows:
\begin{align*}
\Ob({𝓒}_{X/})&=\{S\colon I{^{⊳}}{→}{𝓒}{\;|\;}S\circ i=X\}\\
\Hom_{{𝓒}_{X/}}(S,S')&=\{\alpha\colon S{→} S'{\;|\;}\alpha\circ i=\id_X\}.
\end{align*}

A {\em colimit of $X$}, denoted $\colim_IX$ or $\colim X,$\index{a symbol!$\colim$} is an initial object in ${𝓒}_{X/}.$
\end{definitionENG}

\begin{definitionRUS}\label{def:coslice and colimit}\index{coslice}\index{category!coslice}\index{colimit}
\end{definitionRUS}

\paragraph{\caseENGRUS{Pushouts}{ / }{Пушауты}}\index{pushout} ~\\
...
\begin{exampleENG}[Cone as colimit]
...
\begin{exampleRUS}[Cone as colimit]
\end{exampleRUS}

\begin{exampleENG}\label{ex:pushout in Top}\index{pushout!of topological spaces}
...
\begin{exampleRUS}\label{ex:pushout in Top}\index{pushout!of topological spaces}
\end{exampleRUS}

\begin{applicationENG}\index{subway}
...
\begin{applicationRUS}\index{subway}
\end{applicationRUS}
