...
\subsubsection{\caseENGRUS{Biological classification}{ / }{Биологическая классификация}}\index{biological classification}
...
\subsubsection{\caseENGRUS{Security}{ / }{Безопасность}}\index{security}
...
\subsubsection{\caseENGRUS{Spaces, e.g. geography}{ / }{Пространства, в том числе, географические}}\index{space}
